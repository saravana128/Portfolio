...
## Work Experience
### Full Stack Engineer | Inchcape Shipping Services
April 2023 - Present | UAE
- Develop business applications and digital workflows using **Outsystems** and the **Microsoft Power Platform**.
...
- Worked as an Outsystems Developer for Baker Hughes.
- Developed an inventory management system for chemical deliveries, including mobile and reactive applications.
- Used the TUS protocol to support asynchronous large-file uploads.

### Outsystems Developer | Netlink Digital Solutions Pvt. Ltd.
January 2021 - September 2021
- Delivered two banking applications for Oman-based clients using Outsystems.
- Created processes and timers to automate transactions and integrated REST APIs.
